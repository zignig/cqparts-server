...
// assetCssSideMenuCss reads file data from disk. It returns an error on failure.
func assetCssSideMenuCss() (*asset, error) {
	path := "/opt/cqparts-server/src/server/asset/css/side-menu.css"
	name := "asset/css/side-menu.css"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
var _bindata = map[string]func() (*asset, error){
	...
	"asset/css/side-menu.css": assetCssSideMenuCss,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"asset": &bintree{nil, map[string]*bintree{
		"css": &bintree{nil, map[string]*bintree{
			...
			"side-menu.css": &bintree{assetCssSideMenuCss, map[string]*bintree{}},
		}},
